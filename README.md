...
## POV calculation
Source code is in the /POVcalculator directory and see Manual of Point Cloud Processing Software.docx
...
#### Inference
When save_visualizations=true is set, visualization point cloud files will be exported, generating instance segmentation, semantic segmentation results, and labeled segmentation results.
